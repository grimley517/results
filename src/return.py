...
for line in open(r"C:\Users\harg5\Google Drive\Sailing\swsc\Results_programs\files\2018_handicaps.csv", "r").readlines():
    tokens = line.split(",")
    if tokens[0] != "":
...
for line in open(r"C:\Users\harg5\Google Drive\Sailing\swsc\Results_programs\files\QE_JULY_2018.csv", "r").readlines():
   line = line.replace('\r', '')
   line = line.replace('\n', '')
   tokens = line.split(",")
